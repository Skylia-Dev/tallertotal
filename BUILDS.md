...
|---|-------|--------|---------|-------------|
| 26 | 2026-09-14 | — | v1.57 | Configuración se saca de la sidebar y se mueve a la topbar (junto a Apariencia y Cerrar sesión), visible solo para SuperAdmin. Empleados queda como único ítem restringido en la sidebar |
