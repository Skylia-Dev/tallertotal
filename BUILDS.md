...
|---|-------|--------|---------|-------------|
| 27 | 2026-09-14 | — | v1.58 | "Empleados" pasa a llamarse "Usuarios" (`/empleados` → `/usuarios`). Se agrega el rol Admin (mismos permisos que Owner para gestionar usuarios). Al crear un usuario ahora se elige el rol (Admin/Empleado/Mecánico) en vez de crear siempre Empleado. El SuperAdmin y el Dueño ya no se pueden borrar desde acá (antes solo el Dueño estaba protegido) |
